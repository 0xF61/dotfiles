" SpaceGray.vim -- NeoVim colorscheme.
...
if g:spacegray_use_italics
  hi Comment       ctermbg=NONE ctermfg=76     guibg=NONE     guifg=#5fd700	 cterm=italic    gui=italic
else
  hi Comment       ctermbg=NONE ctermfg=76     guibg=NONE     guifg=#5fd700	 cterm=NONE      gui=NONE
endif
...
hi Visual          ctermbg=236  ctermfg=NONE   guibg=#FF6611  guifg=#000000  cterm=NONE      gui=NONE
